  ...
  <div class="container">
    ...
    <div class="row centralizar-div-horizontal">
      <div class="col-3">
        <form class="form-config" action="usuario.php?fun=config" method="POST" enctype="multipart/form-data">
          <h2>Meu perfil</h2>
        ...
        <form class="form-config" action="matricula.php?fun=create" method="POST" enctype="multipart/form-data">
          ...
          <div>
            <button class="btn btn-success campo" type="submit" name="enviar" value="enviar">Solicitar</button>
          </div>
        </form>
        ...
        <form class="form-config" id="displayMatricula" action="matricula.php?fun=delete" method="POST" enctype="multipart/form-data">
          <div>
            <h6>Matrículas enviadas para análise</h6>
